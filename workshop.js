...
//const signUpResponse = await authModule.signUp({ email: "riazrooshan@gmail.com", password: "abcd1234" });
...
/*const options = {
    outputs: [
      {
        address: 'riazrooshan@dev.neucron.io',
        note: 'gurudakshina',
        amount: 10
      }
    ]
...
const walletCreation1 = await walletModule.createWallet({ walletName: 'Rooshan' });
