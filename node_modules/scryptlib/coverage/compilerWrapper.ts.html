...
<head>
    <title>Code coverage report for compilerWrapper.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="index.html">All files</a> compilerWrapper.ts</h1>
        <div class='clearfix'>
            
            <div class='fl pad1y space-right2'>
                <span class="strong">70.18% </span>
                <span class="quiet">Statements</span>
                <span class='fraction'>200/285</span>
            </div>
        
            
            <div class='fl pad1y space-right2'>
                <span class="strong">54.45% </span>
                <span class="quiet">Branches</span>
                <span class='fraction'>104/191</span>
            </div>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>199/282</span>
            </div>
...
<a name='L773'></a><a href='#L773'>773</a></td><td class="line-coverage quiet"><span class="cline-any cline-yes">1x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">70x</span>
<span class="cline-any cline-yes">1257x</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { basename, dirname, join } from 'path';
...
export function compile(
  ...
  const outputDir = settings.outputDir || <span class="branch-1 cbranch-no" title="branch not covered" >srcDir;</span>
  const timeout = settings.timeout || 1200000;
  const outputFiles = {};
  try {
    const sourceContent = source.content !== undefined ? <span class="branch-0 cbranch-no" title="branch not covered" >source.content </span>: readFileSync(sourcePath, 'utf8');
    const cmdPrefix = settings.cmdPrefix || <span class="branch-1 cbranch-no" title="branch not covered" >getDefaultScryptc();</span>
    const cmd = `${cmdPrefix} compile ${settings.asm || settings.desc ? '--asm' : <span class="branch-1 cbranch-no" title="branch not covered" >''}</span> ${settings.ast || settings.desc ? '--ast' : <span class="branch-1 cbranch-no" title="branch not covered" >''}</span> ${settings.debug == false ? <span class="branch-0 cbranch-no" title="branch not covered" >'' </span>: '--debug'} -r -o "${outputDir}" ${settings.cmdArgs ? <span class="branch-0 cbranch-no" title="branch not covered" >settings.cmdArgs </span>: ''}`;
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (output.startsWith('Error:') || output.startsWith('Warning:')) {
<span class="cstat-no" title="statement not covered" >      result = getErrorsAndWarnings(output, srcDir, sourceFileName);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (result.errors.length &gt; 0) {</span>
...
&nbsp;
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (settings.ast || settings.desc) {
...
&nbsp;
    let asmObj = null;
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (settings.asm || settings.desc) {
...
&nbsp;
        <span class="missing-if-branch" title="if path not taken" >I</span>if (!settings.debug) {
...
&nbsp;
        <span class="missing-if-branch" title="else path not taken" >E</span>if (match &amp;&amp; match.groups) {
          const fileIndex = parseInt(match.groups.fileIndex);
&nbsp;
          let debugTag: DebugModeTag | undefined;
&nbsp;
          const tagStr = match.groups.tagStr;
          <span class="missing-if-branch" title="if path not taken" >I</span>if (/\w+\.\w+:0/.test(tagStr)) {
<span class="cstat-no" title="statement not covered" >            debugTag = DebugModeTag.FuncStart;</span>
          }
          <span class="missing-if-branch" title="if path not taken" >I</span>if (/\w+\.\w+:1/.test(tagStr)) {
<span class="cstat-no" title="statement not covered" >            debugTag = DebugModeTag.FuncEnd;</span>
          }
...
&nbsp;
          const pos: Pos | undefined = sources[fileIndex] ? {
            file: sources[fileIndex] ? getFullFilePath(sources[fileIndex], srcDir, sourceFileName) : <span class="branch-1 cbranch-no" title="branch not covered" >undefined,</span>
            line: sources[fileIndex] ? parseInt(match.groups.line) : <span class="branch-1 cbranch-no" title="branch not covered" >undefined,</span>
            endLine: sources[fileIndex] ? parseInt(match.groups.endLine) : <span class="branch-1 cbranch-no" title="branch not covered" >undefined,</span>
            column: sources[fileIndex] ? parseInt(match.groups.col) : <span class="branch-1 cbranch-no" title="branch not covered" >undefined,</span>
            endColumn: sources[fileIndex] ? parseInt(match.groups.endCol) : <span class="branch-1 cbranch-no" title="branch not covered" >undefined,</span>
          } : undefined;
&nbsp;
          return {
            opcode: item.opcode,
...
<span class="cstat-no" title="statement not covered" >        throw new Error('Compile Failed: Asm output parsing Error!');</span>
      });
&nbsp;
&nbsp;
      <span class="missing-if-branch" title="else path not taken" >E</span>if (settings.debug) {
...
&nbsp;
    <span class="missing-if-branch" title="else path not taken" >E</span>if (settings.desc) {
      ...
      const description: ContractDescription = {
        ...
        compilerVersion: compilerVersion(settings.cmdPrefix ? settings.cmdPrefix : <span class="branch-1 cbranch-no" title="branch not covered" >getDefaultScryptc())</span>,
        contract: result.contract,
        md5: md5(sourceContent),
        structs: result.structs || <span class="branch-1 cbranch-no" title="branch not covered" >[],</span>
        alias: result.alias || <span class="branch-1 cbranch-no" title="branch not covered" >[],</span>
        abi: result.abi || <span class="branch-1 cbranch-no" title="branch not covered" >[],</span>
...
&nbsp;
      <span class="missing-if-branch" title="else path not taken" >E</span>if (settings.debug &amp;&amp; asmObj) {
...
&nbsp;
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (settings.outputToFiles) {
      Object.keys(outputFiles).forEach(outputType =&gt; {
        const file = outputFiles[outputType];
        <span class="missing-if-branch" title="else path not taken" >E</span>if (existsSync(file)) {
...
<span class="cstat-no" title="statement not covered" >      Object.values&lt;string&gt;(outputFiles).forEach(<span class="fstat-no" title="function not covered" >file </span>=&gt; {</span>
<span class="cstat-no" title="statement not covered" >        if (existsSync(file)) {</span>
<span class="cstat-no" title="statement not covered" >          unlinkSync(file);</span>
        }
      });
    }
...
function addSourceLocation(astRoot, basePath: string, curFileName: string) {
  for (const fileName in astRoot) {
    <span class="missing-if-branch" title="if path not taken" >I</span>if (fileName === 'std') {
<span class="cstat-no" title="statement not covered" >      astRoot['std'] = _addSourceLocationProperty(astRoot['std'], 'std');</span>
    } else {
      const realFileName = fileName === 'stdin' ? curFileName : <span class="branch-1 cbranch-no" title="branch not covered" >fileName;</span>
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!(typeof astObj === 'object')) { <span class="cstat-no" title="statement not covered" >return astObj; </span>}
...
<span class="cstat-no" title="statement not covered" >        astObj.loc = null;</span>
      } else {
        astObj.loc = {
          source: uri,
...
function getFullFilePath(relativePath: string, baseDir: string, curFileName: string): string {
  <span class="missing-if-branch" title="else path not taken" >E</span>if (relativePath.endsWith('stdin')) {
    return join(baseDir, curFileName); // replace 'stdin' with real current compiling file name.
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (relativePath === 'std') {</span>
<span class="cstat-no" title="statement not covered" >    return 'std'; </span>// 
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  return join(baseDir, relativePath);</span>
}
&nbsp;
function getConstructorDeclaration(mainContract): ABIEntity {
  // explict constructor
  <span class="missing-if-branch" title="if path not taken" >I</span>if (mainContract['constructor']) {
<span class="cstat-no" title="statement not covered" >    return {</span>
      type: ABIEntityType.CONSTRUCTOR,
      params: mainContract['constructor']['params'].map(<span class="fstat-no" title="function not covered" >p </span>=&gt; { <span class="cstat-no" title="statement not covered" >return { name: p['name'], type: p['type'] }; </span>}),
    };
  } else {
    // implicit constructor
    <span class="missing-if-branch" title="else path not taken" >E</span>if (mainContract['properties']) {
      return {
        type: ABIEntityType.CONSTRUCTOR,
    ...
    mainContract['functions']
      ...
      .map(f =&gt; {
        const entity: ABIEntity = {
          ...
          name: f['name'],
          index: f['nodeType'] === 'Constructor' ? <span class="branch-0 cbranch-no" title="branch not covered" >undefined </span>: pubIndex++,
...
export function getABIDeclaration(astRoot, alias: AliasEntity[], staticConstInt: Record&lt;string, number&gt;): ABI {
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!mainContract) {
<span class="cstat-no" title="statement not covered" >    return {</span>
      contract: '',
      abi: []
    };
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (isStructType(resolvedAliasType)) {
<span class="cstat-no" title="statement not covered" >    return getStructNameByType(resolvedAliasType);</span>
  } else <span class="missing-if-branch" title="if path not taken" >I</span>if (isArrayType(resolvedAliasType)) {
    const [elemTypeName, arraySizes] = <span class="cstat-no" title="statement not covered" >arrayTypeAndSize(resolvedAliasType);</span>
    const elemType = <span class="cstat-no" title="statement not covered" >isStructType(elemTypeName) ? getStructNameByType(elemTypeName) : elemTypeName;</span>
<span class="cstat-no" title="statement not covered" >    return toLiteralArrayType(elemType, arraySizes);</span>
  }
&nbsp;
...
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (isArrayType(type)) {
    const [elemTypeName, arraySizes] = <span class="cstat-no" title="statement not covered" >arrayTypeAndSizeStr(type);</span>
&nbsp;
    const sizes = <span class="cstat-no" title="statement not covered" >arraySizes.map(<span class="fstat-no" title="function not covered" >size </span>=&gt; {</span>
<span class="cstat-no" title="statement not covered" >      if (/^(\d)+$/.test(size)) {</span>
<span class="cstat-no" title="statement not covered" >        return parseInt(size);</span>
      } else {
<span class="cstat-no" title="statement not covered" >        if (size.indexOf('.') &gt; 0) {</span>
<span class="cstat-no" title="statement not covered" >          return staticConstInt[size];</span>
        } else {
<span class="cstat-no" title="statement not covered" >          return staticConstInt[`${contract}.${size}`];</span>
        }
      }
    });
&nbsp;
<span class="cstat-no" title="statement not covered" >    return toLiteralArrayType(elemTypeName, sizes);</span>
  }
  return type;
}
&nbsp;
...
&nbsp;
  Object.keys(dependencyAsts).forEach(<span class="fstat-no" title="function not covered" >key </span>=&gt; {
<span class="cstat-no" title="statement not covered" >    allAst.push(dependencyAsts[key]);</span>
  });
&nbsp;
...
&nbsp;
  return allAst.map(ast =&gt; {
    return oc(ast).alias([]).map(<span class="fstat-no" title="function not covered" >s </span>=&gt; (<span class="cstat-no" title="statement not covered" >{</span>
      name: s['alias'],
      type: s['type'],
    }));
  }).flat(1);
  ...
  return allAst.map((ast, index) =&gt; {
    return oc(ast).contracts([]).map(contract =&gt; {
      return oc(contract).statics([]).filter(s =&gt; (
        s.const === true &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >s.expr.nodeType === 'IntLiteral'</span>
      )).map(<span class="fstat-no" title="function not covered" >s </span>=&gt; {
&nbsp;
<span class="cstat-no" title="statement not covered" >        return {</span>
  ...
  }).flat(Infinity).reduce(<span class="fstat-no" title="function not covered" >(a</span>cc, item) =&gt; (<span class="cstat-no" title="statement not covered" >acc[item.name] = item.value, acc)</span>, {} as Record&lt;string, number&gt;);
}
&nbsp;
&nbsp;
...
<span class="branch-1 cbranch-no" title="branch not covered" >  case 'linux':</span>
<span class="cstat-no" title="statement not covered" >    return 'compiler/scryptc/linux/scryptc';</span>
<span class="branch-2 cbranch-no" title="branch not covered" >  case 'darwin':</span>
<span class="cstat-no" title="statement not covered" >    return 'compiler/scryptc/mac/scryptc';</span>
<span class="branch-3 cbranch-no" title="branch not covered" >  default:</span>
<span class="cstat-no" title="statement not covered" >    throw `sCrypt doesn't support ${os.platform()}`;</span>
  }
}
&nbsp;
function <span class="fstat-no" title="function not covered" >vscodeExtensionPath(</span>): string {
  const homedir = <span class="cstat-no" title="statement not covered" >os.homedir();</span>
  const extensionPath = <span class="cstat-no" title="statement not covered" >join(homedir, '.vscode/extensions');</span>
<span class="cstat-no" title="statement not covered" >  if (!existsSync(extensionPath)) {</span>
<span class="cstat-no" title="statement not covered" >    throw 'No Visual Studio Code extensions found. Please ensure Visual Studio Code is installed.';</span>
  }
<span class="cstat-no" title="statement not covered" >  return extensionPath;</span>
}
&nbsp;
function <span class="fstat-no" title="function not covered" >findVscodeScrypt(</span>extensionPath: string): string {
  const sCryptPrefix = <span class="cstat-no" title="statement not covered" >'bsv-scrypt.scrypt-';</span>
  let versions = <span class="cstat-no" title="statement not covered" >readdirSync(extensionPath).reduce(<span class="fstat-no" title="function not covered" >(f</span>iltered, item) =&gt; {</span>
<span class="cstat-no" title="statement not covered" >    if (item.indexOf(sCryptPrefix) &gt; -1) {</span>
      const version = <span class="cstat-no" title="statement not covered" >item.substring(sCryptPrefix.length);</span>
<span class="cstat-no" title="statement not covered" >      if (compareVersions.validate(version)) {</span>
<span class="cstat-no" title="statement not covered" >        filtered.push(version);</span>
      }
    }
...
<span class="cstat-no" title="statement not covered" >  versions = versions.sort(compareVersions).reverse();</span>
<span class="cstat-no" title="statement not covered" >  return sCryptPrefix + versions[0];</span>
}
&nbsp;
export function <span class="fstat-no" title="function not covered" >getDefaultScryptc(</span>): string {
&nbsp;
&nbsp;
  const extensionPath = <span class="cstat-no" title="statement not covered" >vscodeExtensionPath();</span>
&nbsp;
  const sCrypt = <span class="cstat-no" title="statement not covered" >findVscodeScrypt(extensionPath);</span>
<span class="cstat-no" title="statement not covered" >  if (!sCrypt) {</span>
<span class="cstat-no" title="statement not covered" >    throw `No sCrypt extension found. Please install it at extension marketplace:</span>
		https://marketplace.visualstudio.com/items?itemName=bsv-scrypt.sCrypt`;
  }
&nbsp;
  const scryptc = <span class="cstat-no" title="statement not covered" >join(extensionPath, sCrypt, getPlatformScryptc());</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (!existsSync(scryptc)) {</span>
<span class="cstat-no" title="statement not covered" >    throw 'No sCrypt compiler found. Please update your sCrypt extension to the latest version';</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  return scryptc;</span>
}
&nbsp;
&nbsp;
&nbsp;
export function desc2CompileResult(description: ContractDescription): CompileResult {
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (description.version === undefined) {
<span class="cstat-no" title="statement not covered" >    throw new Error(errorMessage);</span>
  }
&nbsp;
  <span class="missing-if-branch" title="if path not taken" >I</span>if (description.version &lt; CURRENT_CONTRACT_DESCRIPTION_VERSION) {
<span class="cstat-no" title="statement not covered" >    console.warn(errorMessage);</span>
  }
&nbsp;
  const result: CompileResult = {
    ...
    buildType: description.buildType || <span class="branch-1 cbranch-no" title="branch not covered" >BuildType.Debug,</span>
    errors: [],
    warnings: [],
    asm: asm.map((opcode, index) =&gt; {
      const item = description.sourceMap &amp;&amp; description.sourceMap[index];
      <span class="missing-if-branch" title="else path not taken" >E</span>if (item) {
...
&nbsp;
function <span class="fstat-no" title="function not covered" >getErrorsAndWarnings(</span>output: string, srcDir: string, sourceFileName: string): CompileResult {
  const warnings: Warning[] = <span class="cstat-no" title="statement not covered" >[...output.matchAll(WARNING_REG)].map(<span class="fstat-no" title="function not covered" >match </span>=&gt; {</span>
    const filePath = <span class="cstat-no" title="statement not covered" >oc(match.groups).filePath('');</span>
    let message = <span class="cstat-no" title="statement not covered" >oc(match.groups).message('');</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    message = message.replace(/Variable `(?&lt;varName&gt;\w+)` shadows existing binding at (?&lt;fileIndex&gt;[^\s]+):(?&lt;line&gt;\d+):(?&lt;column&gt;\d+):(?&lt;line1&gt;\d+):(?&lt;column1&gt;\d+)/,</span>
...
&nbsp;
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (output.match(INTERNAL_ERR_REG)) {</span>
<span class="cstat-no" title="statement not covered" >    return {</span>
      warnings: warnings,
      errors: [{
        type: CompileErrorType.InternalError,
  ...
  } else <span class="cstat-no" title="statement not covered" >if (output.includes('Syntax error:')) {</span>
    const syntaxErrors: CompileError[] = <span class="cstat-no" title="statement not covered" >[...output.matchAll(SYNTAX_ERR_REG)].map(<span class="fstat-no" title="function not covered" >match </span>=&gt; {</span>
      const filePath = <span class="cstat-no" title="statement not covered" >oc(match.groups).filePath('');</span>
      const unexpected = <span class="cstat-no" title="statement not covered" >oc(match.groups).unexpected('');</span>
      const expecting = <span class="cstat-no" title="statement not covered" >oc(match.groups).expecting('');</span>
<span class="cstat-no" title="statement not covered" >      return {</span>
        type: CompileErrorType.SyntaxError,
        filePath: getFullFilePath(filePath, srcDir, sourceFileName),
        position: [{
...
&nbsp;
    const semanticErrors: CompileError[] = <span class="cstat-no" title="statement not covered" >[...output.matchAll(SEMANTIC_ERR_REG)].map(<span class="fstat-no" title="function not covered" >match </span>=&gt; {</span>
      let message = <span class="cstat-no" title="statement not covered" >oc(match.groups).message('');</span>
      const filePath = <span class="cstat-no" title="statement not covered" >oc(match.groups).filePath('');</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      message = message.replace(/Symbol `(?&lt;varName&gt;\w+)` already defined at (?&lt;fileIndex&gt;[^\s]+):(?&lt;line&gt;\d+):(?&lt;column&gt;\d+):(?&lt;line1&gt;\d+):(?&lt;column1&gt;\d+)/,</span>
